...
//
// search.cpp
// Contains the search() driver function. Prompts the user for a grid file
// name, loads the dictionary and grid, sorts the dictionary, and calls
// findMatches() to write all matched words to an output file.
